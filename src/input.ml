...
let make_self_init () = make @@ R.make_self_init ()

let make_seq_self_init () = make_seq @@ R.make_self_init ()

let make_seq seed = make_seq @@ R.make [| seed |]

let make seed = make (R.make [| seed |])
